...
export default  function TasksTable ({tasks, success, queryParams = null, hideProjectColumn = false }) {
    ...
    return (
     ...
     <thead className="text-xs text-blue-700 bg-blue-50 dark:bg-blue-300
     ...
     <tbody>
         {tasks.data.map((task) => ( 
         <tr className="text-xs text-blue-700 bg-blue-50 dark:bg-blue-300
         dark:text-black-400 border-b-2 border-blue-500" key={task.id}>
             ...
             <th className="px-3 py-2 text-black-980 hover:underline">
