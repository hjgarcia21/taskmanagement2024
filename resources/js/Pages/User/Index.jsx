...
const deleteUser =(user) => {
    if(!window.confirm('Are you sure you want ot delete the task?')){
        return;
    }
    ...
    return(
        <AuthenticatedLayout
            ...
            header={
                ...
                <Link href={route("user.create")}  className="bg-indigo-500 py-1 px-3 text-white rounded
       ...
       >
        ...
        <div className="py-12">
                ...
                {success &&(
                <div className="bg-emerald-500 py-2 px-4 ext-whiite rounded mb-4">
                    {success}
                </div>
                )}
                    <div className="bg-black dark:bg-blue-300 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-black-900 dark:text-black-700">
                       ...
                       <table className="w-full text-sm text-left rtl:text-right
                                ...
                                <tr className="text-nowrap">
                                    ...
                                    <th className="px-3 py-3">
                                        ...
                                        defaultValue={(queryParams.email)}
                                         ...
                                         onBlur={e => searchFieldChanged('email', e.target.
                                        value)}
                            ...
                            <tr className="bg-blue border-b dark:bg-blue-300
                                dark:border-blue-700" key={user.id}>

                                    <td className="px-3 py-2">{user.id}</td>
                                   
                                    <th className="px-3 py-2 text-black-10 hover:underline text-nowrap">
                                    {user.name}
                                    </th>
