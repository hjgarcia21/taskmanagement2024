    ...
    return(
        <AuthenticatedLayout
            ...
            header={
                ...
                <Link href={route("project.create")} className="bg-indigo-500 py-1 px-3 text-white rounded
       ...
       >
        ...
        <div className="py-12">
                ...
                {success &&(
                <div className="bg-blue-500 py-2 px-4 ext-black rounded mb-4">
                    {success}
                </div>
                )}
                    <div className="bg-black dark:bg-blue-300 overflow-hidden shadow-sm sm:rounded-lg">
                       ...
                       <table className="w-full text-sm text-left rtl:text-right
                            ...
                            <tbody>
                                ...
                                dark:border-blue-700" key={project.id}>
                                    <td className="px-3 py-2">{project.id}</td>
                                    <td className="px-3 py-2">
                                        <img src={project.image_path} style={{width:60}} alt=""/>
                                    </td>
                                    <th className="px-3 py-2 text-black-100 hover:underline text-nowrap">
